    ...
    return (
        <section className='py-20 text-white flex flex-col items-center sm:flex-row-reverse sm:justify-between'>
            ...
            <div className='mb-10 sm:mb-0 max-w-[600px]'>
                <p className='uppercase font-semibold mb-5'>{analytics.subtitle}</p>
                <h1 className='font-outfit text-6xl font-bold mb-5'>{analytics.title}</h1>
            ...
            <img className='w-[350px] h-[350px] md:w-[450px] md:h-[450px]' src={analytics.image} />
